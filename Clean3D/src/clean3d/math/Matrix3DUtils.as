package clean3d.math {
	...
	public class Matrix3DUtils {
        ...
        public static function createOrthoMatrixLH(matrix:Matrix3D,w:Number,h:Number,near:Number,far:Number):Matrix3D{
            var raw:Vector.<Number> = Matrix3DUtils.RAW_DATA_CONTAINER;
            raw[uint(0)] = 2/w;
            raw[uint(5)] = 2/h;
            raw[uint(10)] = 1/(far - near);
            raw[uint(14)] = near/(near - far);
        ...
        public static function createOrthoOffCenterMatrixLH(matrix:Matrix3D,minX:Number, maxX:Number, minY:Number, maxY:Number,near:Number,far:Number):Matrix3D{
            var raw:Vector.<Number> = Matrix3DUtils.RAW_DATA_CONTAINER;
            var w:Number = 1/(maxX - minX);
            var h:Number = 1/(maxY - minY);
            var d:Number = 1/(far - near);
        ...
        public static function createPerspectiveMatrixLH(matrix:Matrix3D,w:Number,h:Number,near:Number,far:Number):Matrix3D{
            var raw:Vector.<Number> = Matrix3DUtils.RAW_DATA_CONTAINER;
            raw[uint(0)] = 2*near/w;
            raw[uint(5)] = 2*near/h;
